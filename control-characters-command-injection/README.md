...
## Links
- Blog post page: [Copy and Pwnd: Leverage ASCII characters to exploit VS Code](https://portswigger.net/research/copy-and-pwnd-leverage-ascii-characters-to-exploit-vs-code)
